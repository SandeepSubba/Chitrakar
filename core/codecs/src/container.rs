...
mod tests {
    ...
    fn a_file_written_before_a_field_existed_still_opens() {
        ...
        const ALWAYS: &[&str] = &[
            ...
            // is on a layer.
            "/document/nodes/*/kind/Paint/strokes/*/clip/kind/Vector/shape/Rect:height",
            "/document/nodes/*/kind/Paint/strokes/*/clip/kind/Vector/shape/Rect:width",
            "/document/nodes/*/kind/Paint/strokes/*/clip/kind/Vector/transform:a",
            "/document/nodes/*/kind/Paint/strokes/*/clip/kind/Vector/transform:b",
            "/document/nodes/*/kind/Paint/strokes/*/clip/kind/Vector/transform:c",
            "/document/nodes/*/kind/Paint/strokes/*/clip/kind/Vector/transform:d",
            "/document/nodes/*/kind/Paint/strokes/*/clip/kind/Vector/transform:e",
            "/document/nodes/*/kind/Paint/strokes/*/clip/kind/Vector/transform:f",
            "/document/nodes/*/kind/Paint/strokes/*/clip/kind/Vector:shape",
            "/document/nodes/*/kind/Paint/strokes/*/clip/kind/Vector:transform",
            "/document/nodes/*/kind/Paint/strokes/*/clip:invert",
            "/document/nodes/*/kind/Paint/strokes/*/clip:kind",
            ...
            "/document/regions/*/mask/kind/Vector/shape/Rect:height",
            "/document/regions/*/mask/kind/Vector/shape/Rect:width",
            "/document/regions/*/mask/kind/Vector/transform:a",
            "/document/regions/*/mask/kind/Vector/transform:b",
            "/document/regions/*/mask/kind/Vector/transform:c",
            "/document/regions/*/mask/kind/Vector/transform:d",
            "/document/regions/*/mask/kind/Vector/transform:e",
            "/document/regions/*/mask/kind/Vector/transform:f",
            "/document/regions/*/mask/kind/Vector:shape",
            "/document/regions/*/mask/kind/Vector:transform",
            "/document/regions/*/mask:invert",
            "/document/regions/*/mask:kind",
            "/document/regions/*:mask",
            "/document/regions/*:name",
            "/document/resources/*:height",
            "/document/resources/*:width",
            "/document/selection/kind/Vector/shape/Ellipse:rx",
            "/document/selection/kind/Vector/shape/Ellipse:ry",
            "/document/selection/kind/Vector/transform:a",
            "/document/selection/kind/Vector/transform:b",
            "/document/selection/kind/Vector/transform:c",
            "/document/selection/kind/Vector/transform:d",
            "/document/selection/kind/Vector/transform:e",
            "/document/selection/kind/Vector/transform:f",
            "/document/selection/kind/Vector:shape",
